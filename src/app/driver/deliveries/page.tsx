                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: '0.7rem', color: '#6b7280', display: 'flex', alignItems: 'center', gap: 4 }}>
                        ...
                        {Boolean((req as Record<string, unknown>).client_is_verified) && <span style={{ background: '#10b981', color: '#fff', borderRadius: 99, fontSize: '0.6rem', fontWeight: 800, padding: '1px 5px' }}>✅ Verificado</span>}
