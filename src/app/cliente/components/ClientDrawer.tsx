...
const icons: Record<string, React.ReactNode> = {
  ...
  wrench: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 4a7 7 0 016.32 10.02L21 17.59 17.59 21l-3.57-3.68A7 7 0 1111 4z" /></svg>,
};
