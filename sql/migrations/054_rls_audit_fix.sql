...
-- PostGIS extension table: owned by extension, skip silently if not owner
...
EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN insufficient_privilege THEN NULL; END $$;
